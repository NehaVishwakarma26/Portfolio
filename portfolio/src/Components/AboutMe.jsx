...
About Me    </Typography>
    <Grid container spacing={2} marginLeft={2} paddingBottom={10}>
        ...
        I'm a Computer Engineering student living in Mumbai, a creative web developer passionate about crafting functional, user-friendly applications. With expertise in the MERN stack, I love bringing innovative projects to life.
